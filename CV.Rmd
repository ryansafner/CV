...
output: 
  ...
  header-includes:
    ...
    - \\lhead{Ryan Safner}
    - \\rhead{\thepage}
    - \\cfoot{\begin{footnotesize} Last updated: \today \\ \href{\footerlink}{\texttt{\footerlink}} \end{footnotesize} }
    - \usepackage{sectsty}
...
\subsection*{Wake Forest University}
\begin{itemize}
...
\section*{Service to Hood College}
\begin{itemize}
